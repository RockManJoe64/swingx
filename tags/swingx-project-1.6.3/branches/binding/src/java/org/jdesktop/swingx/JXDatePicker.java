...
import org.jdesktop.swingx.binding.JXDatePickerBinding;
...
public class JXDatePicker extends JComponent implements DataAware {
    ...
    private final class TodayPanel extends JXPanel {
        ...
        private final class TodayAction extends LinkAction {
            TodayAction() {
    ...
    private JXDatePickerBinding binding;
    ...
    private void bind() {
        binding = (JXDatePickerBinding)DataBoundUtils.bind(ctx, this, dataPath);
        if (binding != null) {
