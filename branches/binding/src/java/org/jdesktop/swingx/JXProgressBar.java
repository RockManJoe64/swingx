...
import org.jdesktop.swingx.binding.JProgressBarBinding;
 ...
 * @author rbair
 */
public class JXProgressBar extends JProgressBar implements DataAware/*implements DesignMode*/ {
   /**
    * @inheritDoc
    */
    ...
    */
    ...
    private JProgressBarBinding binding;
    ...
    private void bind() {
        binding = (JProgressBarBinding)DataBoundUtils.bind(ctx, this, dataPath);
        if (binding != null) {
