...
import org.jdesktop.swingx.binding.JSpinnerBinding;
 ...
 * @author rbair
 */
public class JXSpinner extends JSpinner implements DataAware/*implements DesignMode*/ {
    /**
     * @inheritDoc
     */
    public JXSpinner() {
    ...
    private JSpinnerBinding binding;
    ...
    private void bind() {
        binding = (JSpinnerBinding)DataBoundUtils.bind(ctx, this, dataPath);
        if (binding != null) {
